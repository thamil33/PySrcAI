...
from agentica_pyscrai.config.config import EmbeddingConfig
from agentica_pyscrai.adapters.embeddings import (
    BaseEmbedder,
    create_embedder,
...
@patch('agentica_pyscrai.adapters.embeddings.sentence_transformers.SentenceTransformer')
...
def test_create_embedder(mock_hf_config, mock_st_config):
    ...
    with patch.dict('os.environ', {'HF_API_TOKEN': 'test-token'}):
        ...
        with patch('agentica_pyscrai.adapters.embeddings.sentence_transformers.SentenceTransformer') as mock_st:
