...
from pysrcai.agentica.config.config import EmbeddingConfig
from pysrcai.agentica.adapters.embeddings import (
    BaseEmbedder,
    create_embedder,
...
@patch('pysrcai.agentica.adapters.embeddings.sentence_transformers.SentenceTransformer')
