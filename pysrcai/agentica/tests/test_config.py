from pysrcai.agentica.config import (
...
def test_load_template():
    ...
    # Test rag template
    cfg = load_template("rag")
    assert isinstance(cfg, AgentConfig)
    assert cfg.models.provider in ("lmstudio", "openrouter")
    assert cfg.embedding.provider == "local_sentencetransformers"

# Test list_templates and assertions of chat and rag templates
