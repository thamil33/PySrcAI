...
from pysrcai.agentica.config.config import AgentConfig, ChunkingConfig, VectorDBConfig, EmbeddingConfig
from pysrcai.agentica.ingestion.pipeline import IngestionPipeline
from pysrcai.agentica.ingestion.loaders import TextLoader, JSONLoader, DirectoryLoader
from pysrcai.agentica.ingestion.chunkers import TextChunker, SemanticChunker
...
@patch('pysrcai.agentica.ingestion.pipeline.create_chunker')
@patch('pysrcai.agentica.ingestion.pipeline.create_vectorstore')
