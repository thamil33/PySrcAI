"""
Default RAG Setup Example for pysrcai

This script demonstrates how to set up a complete RAG system for ingesting
and querying LangChain documentation using pysrcai's default configuration.
...
from pysrcai.agentica.config.config import AgentConfig, load_template
from pysrcai.agentica.agents.builder import AgentBuilder


def main():
    """Demonstrate default RAG setup with LangChain docs."""
    print("🚀 pysrcai Default RAG Setup Example")
    print("=" * 50)
    ...
    try:
        ...
        print("  python -m pysrcai.agentica.cli --config config/default.yml --interactive")
