...
from pysrcai.agentica.config.config import ModelConfig, AgentConfig
from pysrcai.agentica.adapters.llm import OpenRouterLLM
...
def llm_node(state: State) -> dict:
    ...
    llm = OpenRouterLLM(
        ...
        temperature=0.7,
        max_tokens=500,
        app_name="pysrcai_example",
        site_url="https://github.com/tyler-richardson/pysrcai_workstation",
