...
from agentica_pyscrai.config.config import ModelConfig, AgentConfig
from agentica_pyscrai.adapters.llm import OpenRouterLLM
...
def llm_node(state: State) -> dict:
    ...
    llm = OpenRouterLLM(
        ...
        temperature=0.7,
        max_tokens=500,
        app_name="agentica_pyscrai_example",
        site_url="https://github.com/tyler-richardson/pyscrai_workstation",
        # Provider routing for reliability
        provider={
            "allow_fallbacks": True,
            "data_collection": "deny",  # Privacy-focused routing
            "sort": "price"  # Cost optimization
        }
    )
...
def provider_routing_example():
    ...
    # Example 3: Specific provider with fallbacks
