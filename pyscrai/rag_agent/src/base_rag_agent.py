...
class BaseRAGAgent(ABC):
    ...
    def query(self, question: str, top_k: int = None) -> str:
        ...
        relevant_docs = self.vector_db.query(question, self.embedding_adapter, top_k=top_k)
        
        # Generate response using LLM
        return self._generate_response(question, relevant_docs)
    
    def _generate_response(self, question: str, relevant_docs: List[Dict[str, Any]]) -> str:
